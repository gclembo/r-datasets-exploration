...
#| fig-cap: Sleep Data Distribution
sleep |> 
...
Before I can use a paired t-test, I must first ensure the distribution of the differences between the change in hours slept for a person given drug 1 vs drug 2.
